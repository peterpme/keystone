...
module.exports = function createStaticRouter (keystone) {
    ...
    router.get('/admin/bundles/js/' + keystoneHash + '-FieldTypes', bundles.fields.serve);
    router.get('/admin/bundles/js/' + keystoneHash + '-Signin/index.js', bundles.signin.serve);
    router.get('/admin/bundles/js/' + keystoneHash + '-App/index.js', bundles.admin.serve);
